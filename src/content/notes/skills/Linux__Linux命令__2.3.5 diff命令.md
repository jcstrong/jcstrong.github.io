...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.3.5 diff命令.md"
updated: 2021-02-07
readingTime: 4
summary: "toc  diff  比较给定的两个文件的不同  补充说明  diff命令 在最简单的情况下，比较给定的两个文件的不同。如果使用“”代替“文件”参数，则要比较的内容将来自标准输入。diff命令是以逐行的方式，比较文本文件的异同处。如果该命令..."
---
[toc]
...
说明：
上面的"3c3"表示log1和log2文件在3行内容有所不同；

"5,6d4"表示第2个文件比第1个文件多了第5和6行。
...
### 2. 并排格式输出	diff log1 log2  -y -W 50
...
### 4. 比较两个文件不同，并生产补丁	diff -ruN  log1.bak  log1 > patch.log
