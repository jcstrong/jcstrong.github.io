...
![dataset数据示例](https://s2.loli.net/2022/04/20/sS45jvVpDR9UfxK.png)
...
1. `torchvision`提供了对==图片数据处理==相关的api和数据
   - 数据位置：`torchvision.datasets`，例如：`torchvision.datasets.MNIST`(手写数字图片数据)
2. `torchtext`提供了对==文本数据处理==相关的API和数据
...
![MNIST-dataset](https://s2.loli.net/2022/04/20/ay9tFoJfl1KegnZ.png)
...
![](https://s2.loli.net/2022/04/20/qvs6JUgZAR1xBjw.png)
