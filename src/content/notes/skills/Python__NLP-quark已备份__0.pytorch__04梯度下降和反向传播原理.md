...
tags: ["PyTorch", "AI 模型"]
featured: false
source: "Python/NLP-quark已备份/0.pytorch/04梯度下降和反向传播原理.md"
updated: 2023-03-05
readingTime: 5
summary: "toc\r \r  梯度下降和反向传播\r \r \r \r  1. 梯度是什么?\r \r 梯度：是一个向量，导数+变化最快的方向学习的前进方向\r \r 回顾机器学习\r \r 收集数据$x$ ，构建机器学习模型$f$，得到$fx,w = Y_{predict..."
---
...
![](https://s2.loli.net/2022/04/19/Fst2bd4iKny13S6.png)

==随机选择==一个起始点$w_0$,通过调整$w_0$，让loss函数取到最小值

![](https://s2.loli.net/2022/04/19/TsPoWYarAwvnjKS.png)
...
![](https://s2.loli.net/2022/04/19/aF1RkJoZGtsy4CE.png)

==绘制成为计算图之后，可以清楚的看到向前计算的过程==

之后，对每个节点求偏导可有：

![](https://s2.loli.net/2022/04/19/ip1bBqDPmTS5IoW.png)
...
![](https://s2.loli.net/2022/04/19/S6a1t2qQ89YdWwr.png)

#### 3.2.2 神经网络的计算图

![](https://s2.loli.net/2022/04/19/UkPOsWve4TfMmQq.png)
...
**问题：**那么此时  **$w_1[1,2]$的偏导**  该如何求解呢？

通过观察，发现从$out$ 到$w_1[1,2]$的来连接线有两条

![](https://s2.loli.net/2022/04/19/sZxHYafLB3Tgc8S.png)
...
所以反向传播的思想就是==对其中的某一个参数单独求梯度，之后更新==，如下图所示：

![](https://s2.loli.net/2022/04/19/Hjzl5EnricTgpqV.png)
...
![](https://s2.loli.net/2022/04/19/1ghBj7tXLWFEKv5.png)
...
![](https://s2.loli.net/2022/04/19/BuizCJAZrb134cV.png)
