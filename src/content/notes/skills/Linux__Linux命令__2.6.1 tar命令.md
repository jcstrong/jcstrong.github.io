...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.6.1 tar命令.md"
updated: 2021-02-09
readingTime: 8
summary: "toc  tar  Linux下的归档使用工具，用来打包和备份 补充说明 tar命令 可以为linux的文件和目录创建档案。利用tar，可以为某一特定文件创建档案（备份文件），也可以在档案中改变文件，或者向档案中加入新的文件。tar最初被用..."
---
[toc]
