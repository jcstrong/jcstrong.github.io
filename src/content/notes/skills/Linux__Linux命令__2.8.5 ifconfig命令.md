---
title: "2.8.5 ifconfig命令"
category: skills
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.8.5 ifconfig命令.md"
updated: 2021-03-01
readingTime: 4
summary: "toc  ifconfig  配置和显示Linux系统网卡的网络参数   语法 \tifconfig参数 补充说明 ifconfig命令 被用于配置和显示Linux内核中网络接口的网络参数。用ifconfig命令配置的网卡信息，在网卡重启后机..."
---
[toc]
