...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.6.2 gzip命令.md"
updated: 2021-03-02
readingTime: 4
summary: "toc  gzip  是使用广泛的压缩程序，文件经它压缩过后，其名称后面会多出\".gz\"的扩展名  语法 \tgzip选项参数 补充说明 文件经它压缩过后，其名称后面会多处“.gz”扩展名。 gzip是在Linux系统中经常使用的一个对文件进..."
---
[toc]
