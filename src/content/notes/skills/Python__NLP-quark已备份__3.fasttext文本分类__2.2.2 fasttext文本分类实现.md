---
title: "2.2.2 fasttext文本分类实现"
category: skills
tags: ["fastText", "NLP"]
featured: false
source: "Python/NLP-quark已备份/3.fasttext文本分类/2.2.2 fasttext文本分类实现.md"
updated: 2023-03-05
readingTime: 5
summary: "fastText实现文本分类\r \r 1. 知道fastext是什么\r 2. 能够应用fasttext进行文本分类\r 3. 能够完成项目中意图识别的代码\r \r \r \r  1.  fastTexthttps://fasttext.cc/docs..."
---
## fastText实现文本分类
...
### 1.  [fastText](https://fasttext.cc/docs/en/support.html)的介绍
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/%E6%95%B0%E6%8D%AE%E5%87%86%E5%A4%871.png)

![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/%E6%95%B0%E6%8D%AE%E5%87%86%E5%A4%872.png)
