---
title: "2.2.1 分类的目的和方法"
category: skills
tags: ["fastText", "NLP"]
featured: false
source: "Python/NLP-quark已备份/3.fasttext文本分类/2.2.1 分类的目的和方法.md"
updated: 2023-03-05
readingTime: 2
summary: "分类的目的和分类的方法\r \r 1. 能够说出项目中进行文本的目的\r 2. 能够说出意图识别的方法\r 3. 能够说出常见的分类的方法\r \r  1. 文本分类的目的\r \r 回顾之前的流程，我们可以发现文本分类的目的就是为了进行意图识别\r \r 在..."
---
## 分类的目的和分类的方法
