...
tags: ["HMM", "CRF", "NLP"]
featured: false
source: "Python/NLP-quark已备份/6.其他算法/最大匹配法.md"
updated: 2023-03-04
readingTime: 2
summary: "最大匹配法\r \r  目标\r \r 1. 知道正向最大匹配法\r 2. 知道逆向最大匹配法\r 3. 知道双向最大匹配法\r \r \r \r  起源\r \r 最大匹配法是最简单的分词方法，他完全使用词典进行分词，如果词典好，则分词的效果好\r \r \r \r  ..."
---
# 最大匹配法
