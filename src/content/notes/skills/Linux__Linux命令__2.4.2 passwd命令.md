---
title: "2.4.2 passwd命令"
category: skills
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.4.2 passwd命令.md"
updated: 2021-02-09
readingTime: 3
summary: "toc  passwd  更改用户的密码  补充说明  passwd命令 用于设置用户的认证信息，包括用户密码、密码过期时间等。系统管理者则能用它管理系统用户的密码。只有管理者可以指定用户名称，一般用户只能变更自己的密码。   语法 \tpa..."
---
[toc]
