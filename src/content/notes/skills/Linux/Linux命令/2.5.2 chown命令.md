...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.5.2 chown命令.md"
updated: "2021-02-09"
readingTime: 2
summary: "toc  chown  用来变更文件或目录的所有者或所属群组 补充说明 chown命令 改变某个文件或目录的所有者和所属的组，该命令可以向某个用户授权，使该用户变成指定文件的所有者或者改变文件所属的组。用户可以是用户或者是用户D，用户组可以..."
---
[toc]
