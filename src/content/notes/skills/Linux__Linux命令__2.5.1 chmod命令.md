...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.5.1 chmod命令.md"
updated: 2022-05-23
readingTime: 5
summary: "toc  chmod命令  变更文件或目录的权限 补充说明 chmod命令用于设置文件或目录的权限，可以采用两种形式的权限表示方法：字符形式和数字形式。r、w、x权限字符可分别表示为八进制数字4、2、1，表示一个权限组合时需要将数字进行累加..."
---
[toc]
...
<img src="https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/img/4.png" alt="截屏2021-02-09 下午4.26.21" />

u、g、o、a --------- 文件所有者、文件所属组、其他用户、所有用户

+、-、= -----------增加、减少、赋予（取消原先所有权限，增加现有权限）

```
[root@localhost test]# ll file5.txt
-rw-rw-r--. 1 it it 0 2月   8 06:06 file5.txt
[root@localhost test]# chmod a-rw file5.txt
[root@localhost test]# ll file5.txt 
----------. 1 it it 0 2月   8 06:06 file5.txt
[root@localhost test]# ll file5.txt 
-rw-rw-rw-. 1 it it 0 2月   8 06:06 file5.txt
[root@localhost test]# chmod a+rw file5.txt
[root@localhost test]# ll file5.txt 
-rw-rw-rw-. 1 it it 0 2月   8 06:06 file5.txt
[root@localhost test]# chmod o-w file5.txt
[root@localhost test]# ll file5.txt 
-rw-rw-r--. 1 it it 0 2月   8 06:06 file5.txt
```
