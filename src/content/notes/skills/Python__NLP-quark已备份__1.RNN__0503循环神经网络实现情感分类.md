---
title: "0503循环神经网络实现情感分类"
category: skills
tags: ["RNN", "NLP"]
featured: false
source: "Python/NLP-quark已备份/1.RNN/0503循环神经网络实现情感分类.md"
updated: 2022-07-06
readingTime: 9
summary: "toc\r \r  Pytorch中LSTM和GRU模块使用\r \r  1.1 LSTM介绍\r \r LSTM和GRU都是由torch.nn提供\r \r 通过观察文档，可知LSMT的参数，\r \r torch.nn.LSTMinput_size,hid..."
---
[toc]

# Pytorch中LSTM和GRU模块使用
...
实例化LSTM对象之后,**不仅需要传入数据，还需要h_0(前一次的隐藏状态)和c_0（前一次memory）**
