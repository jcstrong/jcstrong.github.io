---
title: "2.3.5 BeamSearch的原理和实现"
category: skills
tags: ["Seq2Seq", "Attention", "NLP"]
featured: false
source: "Python/NLP-quark已备份/4.Seq2Seq模型/2.3.5 BeamSearch的原理和实现.md"
updated: 2023-03-05
readingTime: 7
summary: "Beam Search\r \r  目标\r \r 1. 知道beam search的概念和原理\r 2. 能够在代码中使用Beam search 完成预测过程\r \r \r \r  1. Beam Search的介绍\r \r  在进行模型评估的过程中，每次..."
---
# Beam Search
...
>
> ![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/greedy%20search.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/beamsearch.png)
