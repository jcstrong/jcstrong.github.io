...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.3.6 patch命令.md"
updated: 2021-03-01
readingTime: 3
summary: "toc  patch  为开放源代码软件安装补丁程序  补充说明  patch命令 被用于为开放源代码软件安装补丁程序。让用户利用设置修补文件的方式，修改，更新原始文件。   语法 \tpatch options originalfile p..."
---
[toc]
