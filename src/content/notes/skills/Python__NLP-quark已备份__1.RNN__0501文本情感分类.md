...
tags: ["RNN", "NLP"]
featured: false
source: "Python/NLP-quark已备份/1.RNN/0501文本情感分类.md"
updated: 2023-03-05
readingTime: 10
summary: "文本情感分类\r \r  目标\r \r 1. 知道文本处理的基本方法\r 2. 能够使用数据实现情感分类的\r \r \r \r  1. 案例介绍\r \r 为了对前面的word embedding这种常用的文本向量化的方法进行巩固，这里我们会完成一个文本情感..."
---
# 文本情感分类
...
![](https://s2.loli.net/2022/04/21/7VXL5TFoqRxCEtW.png)
...
![情感分类-data加载1](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/%E6%83%85%E6%84%9F%E5%88%86%E7%B1%BB-data%E5%8A%A0%E8%BD%BD1.png)
...
**报错each element in list of batch should be of equal size**
...
> 再介绍word embedding的时候，我们说过，不会直接把文本转化为向量，而是==把文本先转化为数字，再把数字转化为向量==，那么这个过程该如何实现呢？

==word embedding的行是词语的数量,列是维数==
...
4. 不同句子长度不相同，==每个batch的句子构造成相同的长度==（可以对短句子进行填充，填充特殊字符）
