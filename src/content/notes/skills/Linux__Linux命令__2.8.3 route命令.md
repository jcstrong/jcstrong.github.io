...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.8.3 route命令.md"
updated: 2021-03-02
readingTime: 4
summary: "toc  route  显示并设置Linux中静态路由表   语法 \troute选项参数 补充说明 route命令 用来显示并设置Linux内核中的网络路由表，route命令设置的路由主要是静态路由。要实现两个不同的子网之间的通信，需要一台..."
---
[toc]
...
### 10. 在当前路由表中增加一条规则：拒绝数据包路由到私有网络10.0.0.0，子网掩码为255.0.0.0
