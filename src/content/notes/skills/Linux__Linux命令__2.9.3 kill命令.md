...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.9.3 kill命令.md"
updated: 2021-03-02
readingTime: 2
summary: "toc  kill  删除执行中的程序或工作   语法 \tkill选项参数 选项 \ta：当处理当前进程时，不限制命令名和进程号的对应关系； \tl <信息编号：若不加<信息编号选项，则l参数会列出全部的信息名称； \tp：指定kill 命令只打..."
---
[toc]
