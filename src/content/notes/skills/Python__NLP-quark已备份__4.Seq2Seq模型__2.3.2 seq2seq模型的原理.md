---
title: "2.3.2 seq2seq模型的原理"
category: skills
tags: ["Seq2Seq", "Attention", "NLP"]
featured: false
source: "Python/NLP-quark已备份/4.Seq2Seq模型/2.3.2 seq2seq模型的原理.md"
updated: 2023-03-05
readingTime: 14
summary: "Seq2Seq模型的原理\r \r  目标\r \r 1. 知道seq2seq的常见应用场景\r 2. 能够说出常见的seq2seq的结构\r 3. 能够使用代码完成基础的seq2seq的结构\r \r \r \r  1. Seq2Seq的介绍\r \r http..."
---
# Seq2Seq模型的原理
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/seq2seq.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/Encoder.png)
