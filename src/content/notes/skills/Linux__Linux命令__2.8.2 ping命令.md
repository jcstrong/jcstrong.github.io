...
tags: ["Linux", "运维"]
featured: false
source: "Linux/Linux命令/2.8.2 ping命令.md"
updated: 2021-03-01
readingTime: 2
summary: "toc  ping  测试主机之间网络的连通性   语法 \tping选项参数 补充说明 ping命令 用来测试主机之间网络的连通性。执行ping指令会使用ICMP传输协议，发出要求回应的信息，若远端主机的网络功能没有问题，就会回应该信息，因..."
---
[toc]
