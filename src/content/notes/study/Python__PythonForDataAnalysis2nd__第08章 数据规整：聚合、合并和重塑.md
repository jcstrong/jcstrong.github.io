...
featured: false
source: "Python/PythonForDataAnalysis2nd/第08章 数据规整：聚合、合并和重塑.md"
updated: 2022-09-22
readingTime: 22
summary: "在许多应用中，数据可能分散在许多文件或数据库中，存储的形式也不利于分析。本章关注可以聚合、合并、重塑数据的方法。 首先，我会介绍pandas的层次化索引，它广泛用于以上操作。然后，我深入介绍了一些特殊的数据操作。在第14章，你可以看到这些工..."
---
