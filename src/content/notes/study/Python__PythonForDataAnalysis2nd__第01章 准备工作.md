...
featured: false
source: "Python/PythonForDataAnalysis2nd/第01章 准备工作.md"
updated: 2022-10-18
readingTime: 18
summary: "第三版 英文，但是更新代码 https://wesmckinney.com/book/preliminaries.html  第1章 准备工作  1.1 本书的内容 本书讲的是利用Python进行数据控制、处理、整理、分析等方面的具体细节和..."
---
第三版 英文，但是更新代码
