---
title: "2.4.4 QA机器人排序模型"
category: projects
tags: ["NLP", "QA", "召回排序"]
featured: true
source: "Python/NLP-quark已备份/5.QA机器人/2.4.4 QA机器人排序模型.md"
updated: 2023-03-05
readingTime: 11
summary: "问答机器人排序模型\r \r  目标\r \r 1. 知道模型中排序中的概念和目的\r 2. 知道模型中排序的实现方法\r \r \r \r  1. 排序模型的介绍\r \r 前面的课程中为了完成一个问答机器人，我们先进行了召回，相当于是通过海选的方法找到呢大致..."
---
# 问答机器人排序模型
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/deepqa.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/AAAI.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/pooling.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/elu.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/%E5%AF%B9%E6%AF%94%E6%8D%9F%E5%A4%B1.png)
