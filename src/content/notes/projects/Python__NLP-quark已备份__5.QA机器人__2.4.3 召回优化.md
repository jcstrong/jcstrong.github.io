...
tags: ["NLP", "QA", "召回排序"]
featured: true
source: "Python/NLP-quark已备份/5.QA机器人/2.4.3 召回优化.md"
updated: 2023-03-05
readingTime: 13
summary: "召回过程优化\r \r  目标\r \r 1. 知道优化的方法和思路\r 2. 知道BM25方法的原理和实现\r 3. 能够使用word2vector完成优化过程\r \r  1. 优化思路\r \r 前面的学习，我们能够返回相似的召回结果，但是，如何让这些结..."
---
# 召回过程优化
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/bm25.png)
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/bm25_2.png)
