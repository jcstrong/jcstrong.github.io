---
title: "2.4.2 QA机器人的召回"
category: projects
tags: ["NLP", "QA", "召回排序"]
featured: true
source: "Python/NLP-quark已备份/5.QA机器人/2.4.2 QA机器人的召回.md"
updated: 2023-03-05
readingTime: 6
summary: "问答机器人的召回\r \r  目标\r \r 1. 知道召回的目的\r 2. 能够说出召回的流程\r 3. 能够优化基础的召回逻辑\r \r \r \r  1. 召回的流程\r \r 流程如下：\r \r 1. 准备数据，问答对的数据等\r 2. 问题转化为向量\r 3...."
---
# 问答机器人的召回
...
![](https://chenjun-xs.oss-cn-hangzhou.aliyuncs.com/pysparnn.png)
