---
title: "2.4.5 代码的封装和提供接口"
category: projects
tags: ["NLP", "QA", "召回排序"]
featured: true
source: "Python/NLP-quark已备份/5.QA机器人/2.4.5 代码的封装和提供接口.md"
updated: 2023-03-04
readingTime: 10
summary: "代码封装和对外提供接口\r \r  目标\r \r 1. 能够完成封装的代码\r 2. 能够使用grpc对外提供接口\r 3. 能够使用supervisord完成服务的管理\r \r  1. 完成代码的封装\r \r 代码封装过程中，需要注意，在整个结构中，我..."
---
# 代码封装和对外提供接口
